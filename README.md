...
| Multi-agent Sales Pipeline | Qualifier → Pricer → Responder |
| AI Harness | Topic filtering, retry logic, logging |
| Eval System | Automated testing for AI outputs |
| Telegram AI Bot | First deployed bot |
| Voice AI Bot | Speech-to-text with Whisper |
| Lead Generation Bot | HOT/WARM/COLD scoring |
| Dynamic Pricing Engine | Night/weekend/VIP pricing |
| AI Daily Report | GPT-generated lead summaries |
